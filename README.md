# Base PHP (plus dev) + Nginx Docker image [![Build Status](https://travis-ci.com/ems-project/docker-php-nginx.svg?branch=7.2-dev)](https://travis-ci.com/ems-project/docker-php-nginx)
