# Base PHP + Nginx Docker image [![Build Status](https://travis-ci.com/ems-project/docker-php-nginx.svg?branch=7.3)](https://travis-ci.com/ems-project/docker-php-nginx)
