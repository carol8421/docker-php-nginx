# Base PHP (plus dev) + Nginx Docker image [![Build Status](https://travis-ci.com/ems-project/docker-php-nginx.svg?branch=7.3-dev)](https://travis-ci.com/ems-project/docker-php-nginx)
